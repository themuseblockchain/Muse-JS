...
var debugEmitters = (0, _debug2.default)('muse:emitters');
var debugProtocol = (0, _debug2.default)('muse:protocol');
var debugSetup = (0, _debug2.default)('muse:setup');
var debugApiIds = (0, _debug2.default)('muse:api_ids');
var debugWs = (0, _debug2.default)('muse:ws');
...
var Muse = function (_EventEmitter) {
  _inherits(Muse, _EventEmitter);
  ...
  function Muse() {
    ...
    var _this = _possibleConstructorReturn(this, (Muse.__proto__ || Object.getPrototypeOf(Muse)).call(this, options));
  ...
  _createClass(Muse, [{
    ...
    value: function setWebSocket(url) {
      console.warn("muse.api.setWebSocket(url) is now deprecated instead use muse.config.set('websocket',url)");
    ...
    /**
     * Refreshes API IDs, populating the `Muse::apiIdsP` map.
     *
...
_methods2.default.forEach(function (method) {
  ...
  Muse.prototype[methodName + 'With'] = function Muse$$specializedSendWith(options, callback) {
  ...
  Muse.prototype[methodName] = function Muse$specializedSend() {
...
_bluebird2.default.promisifyAll(Muse.prototype);

// Export singleton instance
var muse = new Muse();
exports = module.exports = muse;
exports.Muse = Muse;
exports.Muse.DEFAULTS = DEFAULTS;