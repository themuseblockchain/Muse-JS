...
module.exports = {
  ...
  vestToMuse: function vestToMuse(vestingShares, totalVestingShares, totalVestingFundMuse) {
    return parseFloat(totalVestingFundMuse) * (parseFloat(vestingShares) / parseFloat(totalVestingShares));
  },
