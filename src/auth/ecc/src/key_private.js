...
class PrivateKey {
    ...
    */
	...
	static fromBufferTruncate(buf) {
        ...
        let outBuffer = new Buffer(32);
        buf.copy(outBuffer, 0, 0, 32);
        return new PrivateKey(BigInteger.fromBuffer(outBuffer));         
    }
    ...
    */
	...
	static fromWifTruncate(_private_wif) {
        let private_wif = new Buffer(base58.decode(_private_wif));
        ...
        private_key = private_key.slice(1);
        return PrivateKey.fromBufferTruncate(private_key);
	}
