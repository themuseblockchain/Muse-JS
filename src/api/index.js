...
const debugEmitters = newDebug('muse:emitters');
const debugProtocol = newDebug('muse:protocol');
const debugSetup = newDebug('muse:setup');
const debugApiIds = newDebug('muse:api_ids');
const debugWs = newDebug('muse:ws');
...
methods.forEach((method) => {
  ...
  Muse.prototype[`${methodName}With`] =
    function Muse$$specializedSendWith(options, callback) {
  ...
  Muse.prototype[methodName] =
    function Muse$specializedSend(...args) {
...
Promise.promisifyAll(Muse.prototype);
